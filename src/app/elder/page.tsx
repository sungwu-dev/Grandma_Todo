...
function ElderPageContent() {
  ...
  return (
    <div className="min-h-[100dvh] bg-gray-50">
      <main className="mx-auto flex min-h-[100dvh] w-full max-w-6xl flex-col gap-3 pb-3 pt-[calc(env(safe-area-inset-top)+56px)] md:grid md:h-[100dvh] md:grid-rows-[auto_1fr] md:overflow-hidden md:gap-3 md:pb-2 md:pt-[calc(env(safe-area-inset-top)+64px)]">
